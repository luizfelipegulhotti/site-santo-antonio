...
>
    <div class="card">
        <a  href="/view/agendamento.php" <?php echo (isset($_GET['page']) && $_GET['page'] == 'agendamento') ? 'class="active"' : ''; ?>>
...
<div class="container">
    <div class="row">
        <div class="col-12 col-md-6 mb-4">
            <h2>Seu título</h2>
            <img src="img/demon.jpg" class="img-fluid1" alt="Imagem 1">
