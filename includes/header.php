...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['enviar_agendamento'])) {
    ...
    $resultado = $controller->salvarAgendamento($_POST);

    if (str_contains($resultado, "sucesso")) {
        $mensagem_sucesso = "<div class='msg sucesso'>$resultado</div>";
    } else {
        $mensagem_erro = "<div class='msg erro'>$resultado</div>";
    }
}
?>
...
<body>
    ...
    <header class="navbar">
        ...
        <ul class="nav-links" id="nav-links">
            ...
            <li><a href="view/agendamento.php" <?php echo (isset($_GET['page']) && $_GET['page'] == 'agendamento') ? 'class="active"' : ''; ?>>Agendamentos</a></li>
